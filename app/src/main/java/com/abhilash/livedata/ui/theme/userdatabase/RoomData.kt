...
fun RoomData(){
    ...
    Column {
        ...
        Text("Enter Information", fontSize = 19.sp,
       ...
       // Text("Select Date ")
        ...
        Spacer(modifier = Modifier.height(10.dp))
        Text("Optional Data (below)", fontSize = 17.sp,color= Color.Red, modifier = Modifier.padding(start=10.dp))
        ...
        OutlinedTextField(
            ...
            onValueChange = { newValue ->
                val textFieldValue = TextFieldValue(newValue, TextRange(newValue.length))
                if (isValidText(textFieldValue)) {
                    todayCollection = textFieldValue.text
                }
            },
            modifier = Modifier
                .fillMaxWidth(0.44f)
